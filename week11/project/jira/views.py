...
class TaskViewSet(viewsets.ModelViewSet):
    queryset = Task.objects.annotate(Count('task_comments'))
    ...
    def perform_create(self, serializer):
        ...
        logger.info(self.request.user,"{self.request.user} created a new task with id %s:",  self.request.data.get('task_id'))
...
class MemberProjectViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        logger.info("there is a new member with id: %s", self.request.data['member_id'])
        if serializer.is_valid():
